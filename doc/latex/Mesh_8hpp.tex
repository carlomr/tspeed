...
\begin{DoxyCompactList}\small\item\em The class with the mesh description (connectivity, neighbors, ...) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Header file for the mesh. \begin{DoxyAuthor}{Author}
Carlo Marcati 
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
2013-\/09-\/08 
