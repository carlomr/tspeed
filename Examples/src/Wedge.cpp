/**
 * @example Wedge.cpp An example implementing the Wedge problem, with the Dubiner 
 * basis and Gauss quadrature. Fields are output.
 *
 *
 * Reference:
 * E. D. Mercerat, J.-P. Vilotte, and F. J. Sanchez-Sesma, Triangular
 * spectral element simulation of two-dimensional elastic wave propagation
 * using unstructured triangular grids, Geophysical Journal 
 * International 166 (2006), no. 2, 679–698.
 * 
***/
#include"TSPEED.hpp"
#include<iostream>
